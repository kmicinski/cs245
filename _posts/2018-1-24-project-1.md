...
- It is okay to work through concepts on the board, but you **may
  ...
  addresses when doing calculations with another studnet. E.g., you
...
the server undeer my desk from sending talking to the rest of the
internet.
...
Attacks can be compicated. You don't want to have to literally sit and
...
- It is **toally okay** if the server crashes after printing "Hello,
  world!"
...
target. Use a disassembler or rever engineering toolkit.
...
security vulernability versus just a bug (that isn't a vulnerability)
